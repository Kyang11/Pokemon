...
class RegisterForm(FlaskForm):
    ...
    r2 = random.randint(2001,3000)
    r3 = random.randint(3001,4000)
    r4 = random.randint(4001,5000)
    ...
    icon = RadioField('Chose an Avatar', validators=[DataRequired()],
...
class EditProfileForm(FlaskForm):
    ...
    icon = RadioField('Pick Ypur Avatar', validators=[DataRequired()],
